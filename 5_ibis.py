...
hdfs_host = os.getenv('HDFS_HOST', 'ip-10-0-0-148.us-west-2.compute.internal')
...
con = ibis.impala.connect('ip-10-0-0-127.us-west-2.compute.internal', hdfs_client=hdfs, database='flights')
