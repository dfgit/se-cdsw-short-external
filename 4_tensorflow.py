...
mnist = input_data.read_data_sets(path.join(cur_project_home, 'data/MNIST/'), one_hot=True)
...
roc_logs_path='/tmp/tensorboard_roc'
...
tensor_utils.start_tensorboard(logs_path, iframe=False)
